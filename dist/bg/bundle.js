...
var ArrayObservable = (function (_super) {
    __extends$10(ArrayObservable, _super);
...
var CombineLatestSubscriber = (function (_super) {
    __extends$13(CombineLatestSubscriber, _super);
...
var AsyncScheduler = (function (_super) {
    __extends$28(AsyncScheduler, _super);
...
var IntervalObservable = (function (_super) {
    __extends$29(IntervalObservable, _super);
...
var MapSubscriber = (function (_super) {
    __extends$39(MapSubscriber, _super);
...
var QueueAction = (function (_super) {
    __extends$41(QueueAction, _super);
...
var QueueScheduler = (function (_super) {
    __extends$42(QueueScheduler, _super);
...
var WebSocketSubject = (function (_super) {
    __extends$44(WebSocketSubject, _super);
...
var ArgumentOutOfRangeError = (function (_super) {
    __extends$64(ArgumentOutOfRangeError, _super);
...
var ElementAtSubscriber = (function (_super) {
    __extends$65(ElementAtSubscriber, _super);
...
var EmptyError = (function (_super) {
    __extends$69(EmptyError, _super);
    function EmptyError() {
...
var FirstSubscriber = (function (_super) {
    __extends$70(FirstSubscriber, _super);
...
var AsapAction = (function (_super) {
    __extends$99(AsapAction, _super);
...
var AsapScheduler = (function (_super) {
    __extends$100(AsapScheduler, _super);
...
var TimeoutError = (function (_super) {
    __extends$109(TimeoutError, _super);
...
var TimeoutSubscriber = (function (_super) {
    __extends$110(TimeoutSubscriber, _super);
...
var ColdObservable = (function (_super) {
    __extends$118(ColdObservable, _super);
...
var HotObservable = (function (_super) {
    __extends$119(HotObservable, _super);
...
var VirtualTimeScheduler = (function (_super) {
    __extends$120(VirtualTimeScheduler, _super);
...
var VirtualAction = (function (_super) {
    __extends$120(VirtualAction, _super);
...
var TestScheduler = (function (_super) {
    __extends$121(TestScheduler, _super);
...
const STRINGS = {
  ...
  transitBalance: "Временный счёт",
  entry: "Поступление"
};

const IGNORING_ACCOUNTS = ["transitBalance"];
//export const IGNORING_ACCOUNTS = [];
...
var ajax$2 = new Ajax({ baseURL: "https://sme.tinkoff.ru" });
...
let Notification$2 = class Notification {
  constructor() {
...
const connected$ = Observable$1.create(function(observer) {
  log("sessionID$");
  ...
  .retryWhen(() => Observable$1.interval(1000))
  .do(sessionID => {
    ajax$2.setToken(sessionID);
    badge.enable();
  });

const validate$ = connected$
  .flatMap(() => {
    log("validate$");
    const promise = ajax$2.post("/api/v1/session/validate").then(data => {
  ...
  .retryWhen(() => Observable$1.interval(10000));

// Update token every 60 seconds
Observable$1.interval(60000)
  .switchMap(() => validate$)
  .subscribe(x => {
    log(x);
  });

const companyID$ = connected$
  .flatMap(() => {
    log("companyID$");
    let promise = ajax$2
      .get(
  ...
  .flatMap(accounts => {
    ...
    return companyID$
      .combineLatest(connected$, companyID => {
        ...
        return Observable$1.fromPromise(promiseAll);
      })
      .flatMap(x => x);
  })
  .retryWhen(() => Observable$1.interval(10000));

const paymentDocuments$ = accounts$
  .publishReplay()
  .refCount()
  .flatMap(accounts => {
    log("statistics$");
